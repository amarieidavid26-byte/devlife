...
capturi de ecran pentru fiecare linie din rubric-matrix.md.

de adaugat inainte de predare:
- `main-menu.png` — meniu principal cu subtitlu in romana
- `hud-biometrics.png` — HUD cu date biometrice live
- `fatigue-firewall.png` — interventie FATIGUE FIREWALL in terminal
- `apply-fix-preview.png` — dialog previzualizare patch (Inainte/Dupa)
- `apply-fix-confirm.png` — dupa confirmare, flash verde in editor
- `apply-fix-rollback.png` — rollback aplicat
- `settings-language.png` — toggle limba RO/EN in setari
