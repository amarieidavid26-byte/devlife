...
puncte:
- 151 teste, coverage ~69% (unit + integration + WS flow + HRV live/RMSSD + dinamica tastarii + calibrare + setari/chei API + ghost brain/analyzer cu client Claude stub-uit + session replay + keystroke firewall + firewall anti-drift)
